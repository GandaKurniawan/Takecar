            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        ...
                        <p>Untuk Pemesanan dan Informasi Lengkap Silahkan Telepon Kontak Kami dan Segera Nikmati Kenyamanan Berkendara Bersama kami.</p>
                    </div>
                </div>
                <!-- Page Title End -->
            </div>
                    ...
                    <div class="contact-form">
                        <form action="index.php">
                            ...
                            <div class="message-input">
                                <textarea name="review" cols="30" rows="10" placeholder="Tulis Komentar di sini!"></textarea>
                            </div>
